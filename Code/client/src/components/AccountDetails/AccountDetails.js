        ...
        <div className="account-card">
          {!loading ? (
            <div className="inner-wrapper">
              <h1>ACCOUNT-SERIAL-NUMBER : {bankingAccount.serial}</h1>
              <h1>ACCOUNT-USERNAME : {bankingAccount.name}</h1>
              <h1>ACCOUNT-ETH-ADDRESS : {bankingAccount.email}</h1>
              <h1>ACCOUNT-BALANCE : {bankingAccountBalance} ETH</h1>
              <h1>ACCOUNT-EMAIL : {bankingAccount.location}</h1>
              <h1>ACCOUNT-CREATE-DATE/TIME : {createdDate}</h1>
            </div>
          ) : null}
        </div>
