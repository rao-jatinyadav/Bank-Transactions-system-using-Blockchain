  ...
  return !loading ? (
    <div className="loan-section">
      <div className="loan-text-wrapper">
        ...
        <h2>
          Here you can get a loan approved quickly and  ,once your loan is approved you will get a prompt every minute to approve the transaction which is of the value of your each installment. In this application every month or installment period is 10 seconds.
        </h2>
        ...
        <h1>BALANCE : {accountBalance} ETH</h1>
      </div>
